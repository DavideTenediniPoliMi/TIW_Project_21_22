...
public class MoveDocument extends Controller {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (documentIdParam == null || documentIdParam.isBlank() || subfolderIdParam == null
				|| subfolderIdParam.isBlank()) {
		...
		dispatchTo(request, response, Paths.TO_SUBFOLDER_PAGE_RELATIVE, new HttpVariable("subfolderId", subfolderId));
	}
}
